...
const LatestPosts: React.FC<LatestPostsProps> = ({ 
  ...
  return (
    <section className={showAll ? 'min-h-screen bg-gray-50' : 'py-16 bg-white'}>
      ...
      {showAll && (
        <div className="max-w-5xl mx-2.5 px-4 py-10 ">
  <div className="bg-[#D8D4CD] rounded-[32px] min-h-[450px] overflow-hidden flex flex-col md:flex-row shadow-lg ">
    {/* Left Image */}
    <div className="md:w-1/2 animate-slide-infromright">
      <img
        src="/blog/blog.png"
        alt="Blog Visual"
        className="w-full h-full p-3 rounded-[40px] min-w-2s object-full"
      />
    </div>
    ...
    <div className="md:w-1/2 p-4 flex flex-col justify-center animate-slide-infromleft">
      ...
      <p className="text-gray-800 mb-6 my-font">
      ...
      {showAll && (
        <div id="articles" className="max-w-7xl px-4 sm:px-6 lg:px-8 mb-12">
